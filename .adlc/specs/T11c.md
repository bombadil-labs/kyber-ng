# T11c — The Memory Store: entities reified to markdown, human edits as deltas (the store learns)

Rev 1 — slice spec of the T11 umbrella contract (`.adlc/specs/T11.md`; spine pins 2, 5, 6, 7, 9, 10 —
...
## ACs (owned by this slice — from the umbrella, verify: methods verbatim)
